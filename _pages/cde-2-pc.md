...
author_profile: no
permalink: /cde-2-pc/
title: "Les cahiers d'entraînement en physique pour les deuxièmes années de prépa"
---

[![cahier d'entraînement](/assets/images/couverture_CdE_PC_2_PC.jpg){:width="500px"}](https://www.dunod.com/prepas-concours/cahier-d-entrainement-en-physique-pc)

Vous pouvez [acheter la version éditée](https://www.dunod.com/prepas-concours/cahier-d-entrainement-en-physique-pc) par Dunod du *cahier d'entraînement en physique*. Le prix est très abordable et le format très pratique.

Ces cahiers d'entraînement sont destinés aux **élèves de deuxième année** post-Bac. Ils permettent aux élèves de s'entraîner en autonomie à l'acquisition de réflexes utiles en physique. 
...
- [La version PC/PC*](/cde-2/CdE_PC_2_PC.pdf)
- [Les autres versions]({{ site.baseurl }}{% link _pages/cde-2.md %})

---

*La dernière version du cahier d'entraînement est la version 1.5.2.*
